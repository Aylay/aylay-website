...
export default function ArticleCard({
  ...
  return (
    <article
      className="card-accent bg-card border border-line rounded-[14px] p-[clamp(24px,3vw,32px)] relative overflow-hidden transition-[transform,border-color] duration-240 hover:-translate-y-1 hover:border-line-2 rv h-full flex flex-col"
    ...
    >
      ...
      {cta && (
        <span className="mt-auto pt-4 inline-flex items-center gap-1.5 font-mono text-[12px] font-bold text-(--c-ink)">
